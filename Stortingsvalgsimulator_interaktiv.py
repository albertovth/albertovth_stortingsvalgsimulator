...
st.warning("""
**Viktig melding:**
Per siste oppdatering 2. juli 2025 er eldste meningsmåling fra 22. mai 2025 og nyeste fra 27. juni 2025.
...
st.markdown("Juster prognoser for valgresultater for valgdistriktene i venstremenyen. Valgdeltagelse per distrikt kan også oppgis nederst i venstremenyen. \n"
            ...
            "siste oppdatering per 27. juni 2025, med estimater for antall personer med stemmerett per valgdistrikt basert på tall for 2023 og ekstrapolering av befolkningsvekst (kilde SSB). Diagram for prognostisert mandatfordeling presenteres nederst i hovedsiden.  \n"
