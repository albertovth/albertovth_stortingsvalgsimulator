...
def plot_half_circle_chart(data, colors):
    ...
    wedges, texts = ax.pie(
        ...
        wedgeprops=dict(width=0.3, edgecolor='none')  # Remove the edge color
    )
...
color_mapping = {
    1: '#8B0000', 2: '#A52A2A', 3: '#CD5C5C', 4: '#F08080', 5: '#FFA07A', 5.5: '#006400',
